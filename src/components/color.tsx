...
import { colorToHex, getColor, getColorDimension, hexToColor } from "../utils";
        ...
        <SidebarPanel title={`${scale.name}.${index}`}>
            <VStack spacing={16}>
                ...
                >
                    <VStack spacing={4}>
                        ...
                        <Input
                            ...
                            type="number"
                            style={{ width: "100%" }}
                            value={getColorDimension(color, "hue")}
                            min={0}
                            max={360}
                            onChange={event => {
                                send({
                    ...
                    <VStack spacing={4}>
                        ...
                        <Input
                            ...
                            type="number"
                            style={{ width: "100%" }}
                            value={getColorDimension(color, "saturation")}
                            min={0}
                            max={100}
                            onChange={event => {
                                send({
                    ...
                    <VStack spacing={4}>
                        ...
                        <Input
                            ...
                            type="number"
                            style={{ width: "100%" }}
                            value={getColorDimension(color, "lightness")}
                            min={0}
                            max={100}
                            onChange={event => {
                                send({
                ...
                <Box as="code" sx={{ fontFamily: "mono", fontSize: 1 }}>
                    hsluv({getColorDimension(computedColor, "hue")},{" "}
                    {getColorDimension(computedColor, "saturation")}%,{" "}
                    {getColorDimension(computedColor, "lightness")}%)
                </Box>
